...
ticker_column = st.column_config.TextColumn(label="Aktuální cena", width="small")
...
st.dataframe(data,width=650, hide_index=True,column_config={"Ticker":ticker_column,"6mo_history": trend_column},height=287)  
